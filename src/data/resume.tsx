...
export const DATA = {
  name: "Joel Rajesh",
  initials: "JR",
  url: "https://joelrajesh.in",
  location: "Kasol",
  locationLink: "https://www.google.com/maps/place/kasol",
  description:
    "Software Engineer. I love building things and helping people. Moderately active on Twitter.",
  summary:
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/joelshejar",
        icon: Icons.github,
  ...
  projects: [
    {
      title: "Rapiddine",
      href: "https://rapiddine.com/",
      dates: "Jan 2024 - Present",
      active: true,
      description:
        "The Recipe for restaurant revolution.",
      technologies: [
        "Next.js",
        "React",
        "React Native",
